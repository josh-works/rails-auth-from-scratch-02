...
class BookQuotesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create book_quote" do
    assert_difference('BookQuote.count') do
      post book_quotes_url, params: { book_quote: { book_title: @book_quote.book_title, quote: @book_quote.quote, references: @book_quote.references } }
    end
  ...
  test "should update book_quote" do
    patch book_quote_url(@book_quote), params: { book_quote: { book_title: @book_quote.book_title, quote: @book_quote.quote, references: @book_quote.references } }
