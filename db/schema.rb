...
ActiveRecord::Schema.define(version: 2022_02_09_180656) do
  ...
  create_table "book_quotes", force: :cascade do |t|
    ...
    t.index ["regular_user_id"], name: "index_book_quotes_on_regular_user_id"
  end
  ...
  add_foreign_key "book_quotes", "regular_users"
end
